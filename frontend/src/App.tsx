      ...
      <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white p-6 mt-auto">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-3">Online Clipboard</h3>
              <p className="text-sm text-gray-300">
                A secure and temporary text sharing service. 
                Share text snippets, code, or any content with a unique code.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">
                We value your privacy. All shared data is automatically deleted after 24 hours, 
                and we don't track any personal information.
              </p>
            </div>
          </div>
          
          <div className="mt-8 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
            <p>&copy; {new Date().getFullYear()} Online Clipboard | Secure and temporary text sharing</p>
          </div>
        </div>
      </footer>
    </div>
